...
function createPublicKeyCredential(options) {
    return __awaiter(this, void 0, void 0, function* () {
        let credential = yield navigator.credentials.create({ publicKey: options });
        return credential;
    });
}
...
function getAssertion(options) {
    return __awaiter(this, void 0, void 0, function* () {
        let credential = yield navigator.credentials.get({ publicKey: options });
        return credential;
    });
}
...
function getCredentialRegistrationData(credential) {
    ...
    let publicKey = CborSimpleDecoder_1.CborSimpleDecoder.readObject(new CborSimpleDecoder_1.BinaryReader(credentialPublicKey.buffer));
...
exports.SHA256 = js_sha256_1.sha256;
exports.CBOR = cbor;
exports.BINARY_READER = CborSimpleDecoder_1.BinaryReader;
exports.CBOR_SIMPLE_DECODER = CborSimpleDecoder_1.CborSimpleDecoder;
exports.BYTE_BASE64 = byteBase64;
